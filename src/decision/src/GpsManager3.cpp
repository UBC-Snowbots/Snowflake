...
GpsManager3::GpsManager3(int argc, char **argv, std::string node_name){
    // Setup NodeHandles
...
void GpsManager3::tfCallBack(const tf2_msgs::TFMessageConstPtr tf_message){
...
std::vector<Waypoint> GpsManager3::parseWaypoints(std::vector<double> waypoints_raw){
...
void GpsManager3::populateWaypointStack(std::vector<Waypoint> waypoint_list){
