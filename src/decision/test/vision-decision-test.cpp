...
TEST(imageTest, moveAwayFromLineAndTurnRight) {
    ...
    EXPECT_NEAR(45,
                VisionDecision::getDesiredAngle(testImageScan->height / 8.0, testImageScan, rolling_average_constant,
                                                percent_of_image_sampled, percent_of_samples_needed, confidence_value,
                                                move_away_threshold, percent_of_white_needed), error_margin);
...
TEST(imageTest, perpendicular) {
    ...
    VisionDecision::getDesiredAngle(testImageScan->height / 8.0, testImageScan, rolling_average_constant,
                                    percent_of_image_sampled, percent_of_samples_needed, confidence_value,
                                    move_away_threshold, percent_of_white_needed);
