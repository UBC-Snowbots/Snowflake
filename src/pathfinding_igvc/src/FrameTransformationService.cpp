...
FrameTransformationService FrameTransformationService::buildService(tf::Quaternion rotation, tf::Vector3 position) {
...
geometry_msgs::Point FrameTransformationService::transformToGridFrame(geometry_msgs::Point point) {
...
geometry_msgs::Point FrameTransformationService::transformToMapFrame(geometry_msgs::Point point) {
