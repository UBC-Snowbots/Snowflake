 ...
 * Description: A service that transforms points between two frames, specifically map and grid frame.
 */
...
public:
     ...
     * Takes in the rotation/orientation and position of the grid frame relative map frame
     * @param rotation rotation/orientation of the grid frame relative expressed map frame
     * @param position position of the grid frame expressed in map frame
     * @return FrameTransformationService
     */
    static FrameTransformationService buildService(tf::Quaternion rotation, tf::Vector3 position);

    /**
     * Takes a point represented in map frame and returns its position in grid frame
    ...
    /**
     * Takes a point represented in grid frame and returns its position in map frame
