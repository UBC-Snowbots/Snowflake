...
public:
    /**
     * Takes a start and goal points in world frame, and returns the shortest path
     ...
     */
    static nav_msgs::Path perform(geometry_msgs::Point start, geometry_msgs::Point goal, nav_msgs::OccupancyGrid grid);
};
