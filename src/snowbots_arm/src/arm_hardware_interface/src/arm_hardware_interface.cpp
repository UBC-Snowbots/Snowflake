...
ArmHardwareInterface::ArmHardwareInterface(ros::NodeHandle &nh) : nh_(nh)
{
	init();
	...
	int baudrate;
	nh_.getParam("/arm/hardware_driver/serial_port", serial_port);
	nh_.getParam("/arm/hardware_driver/baudrate", baudrate);
