...
TEST_F(UtilsTest, minDistanceBetweenSplines_min_point_at_end_of_one_and_midpoint_of_other){
...
TEST_F(UtilsTest, findClosestPointOnSplineToPoint_arc_spline){
    ...
    Point2D closest_point_on_spline = spline(findClosestPointOnSplineToPoint(spline, point));
    Point2D expected_closest_point_on_spline(4,-10);

    EXPECT_NEAR(expected_closest_point_on_spline.x(), closest_point_on_spline.x(), 0.1);
    EXPECT_NEAR(expected_closest_point_on_spline.y(), closest_point_on_spline.y(), 0.1);
}
