...
int maxSpeed[8] = {1400, 1800, 3000, 2500, 5000, 5000, 5000, 5000};
int maxAccel[8] = {2000, 3000, 4000, 3000, 4000, 4000, 4000, 4000};
int homeSpeed[8] = {500, 500, 600, 400, 2000, 2000, 2000, 2000}; // {500, 1500, 700, 1200, 1200, 1200, 1200, 1200};
...
int maxAngles[6] = {130, 70, 160, 100, 80, 80};

const unsigned long readInterval = 15;
...
int i;
static const char fwdValues[] = {'a', 'c'};
static const char revValues[] = {'b', 'd'};
...
long homeCompAngles[] = {axisDir[0]*60, axisDir[1]*5, axisDir[2]*93, axisDir[3]*12, axisDir[4]*102, axisDir[5]*80, axisDir[6]*102, axisDir[7]*80};
long homeCompConst[] = {3000, 2000, 1000, 500, 500, 500, 500, 500};
...
void releaseEvent(char value) { // when user releases a joystick serial sends a character
  ...
  if(value == wristRelease[0]) { // axis 6 released
    steppers[4].stop();
    steppers[5].stop();
    runFlags[4] = 0;
  }

  else if(value == wristRelease[1]) { // axis 5 released
    steppers[6].stop();
    steppers[7].stop();
    runFlags[5] = 0;
  }
