...
protected:
    virtual void SetUp(){
        ...
        test_lwheels_subscriber = nh_.subscribe("/integration_node/lwheels_pub_topic", 1, &MyNodeTest::lwheels_callback, this);
        test_rwheels_subscriber = nh_.subscribe("/integration_node/rwheels_pub_topic", 1, &MyNodeTest::rwheels_callback, this);
