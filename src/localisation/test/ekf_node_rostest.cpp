...
class EKFNodeTest : public testing::Test {
  ...
  public:
	...
	void driveSimulator(double x, double y, double angle, double speed,
	 double ang_vel, int seconds_traveling, std::mt19937 e2) {
		//Set local variables
		int i = 0;
		double measured_x     = x;
		double measured_y     = y;
...
TEST_F(EKFNodeTest, testEKFNode) {
    ...
    driveSimulator(x, y, angle, speed, ang_vel, 50, e2);
    ...
    ang_vel          = -(1. / 16.) * M_PI;
    speed            = 0;
	driveSimulator(x, y, angle, speed, ang_vel, 8, e2);
    ...
    ang_vel          = 0;
    speed            = 4;
    driveSimulator(x, y, angle, speed, ang_vel, 30, e2);
    ...
    ang_vel          = (1. / 8.) * M_PI;
    speed            = 0;
    driveSimulator(x, y, angle, speed, ang_vel, 10, e2);
    ...
    ang_vel          = 0;
    speed            = 2;
    driveSimulator(x, y, angle, speed, ang_vel, 40, e2);
